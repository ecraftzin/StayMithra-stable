...
class _StaymithraHomePageState extends State<StaymithraHomePage> {
  ...
  Future<void> _createSampleDataIfNeeded() async {
    ...
    if (currentUser != null && !_hasCreatedSampleData) {
      ...
      // Removed automatic sample data creation for new users
      // Users should start with empty profiles
      // Sample data can be created manually if needed for testing

      if (mounted) {
        setState(() => _hasCreatedSampleData = true);
      }
      // Refresh feed after initialization
